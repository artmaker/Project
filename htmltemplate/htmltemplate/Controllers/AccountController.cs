...
namespace htmltemplate.Controllers
{
    ...
    public class AccountController : Controller
    {
            ...
            if (confirm == true)
            {
                ...
                //{
                    switch (result)
                    {
                        ...
                        if (usertype == "Admin")
                            return RedirectToAction("Admin", "Upload");
                        if (usertype == "Member")
                            return RedirectToAction("ApproveIdea", "Upload");
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email ,Name=model.Name,Department=model.Department,UserType=model.UserType,TeacherId=model.TeacherId,Confirmed=false};
                ...
                if (result.Succeeded)
                {
                    ...
                    return RedirectToAction("Pleasewait","Account");
                }
                AddErrors(result);
            }
